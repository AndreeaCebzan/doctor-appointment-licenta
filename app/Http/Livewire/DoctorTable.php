...
class DoctorTable extends LivewireTableComponent
{
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make(__('messages.doctor.status'), "status")->addClass('text-center'),
            Column::make(__('messages.common.email_verified'), "email_verified_at")->addClass('text-center'),
            Column::make(__('messages.common.impersonate'))->addClass('text-center'),
