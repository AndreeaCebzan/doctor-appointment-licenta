...
<x-livewire-tables::bs5.table.cell>
    @if($row->view)
        <div class="badge badge-light-success">Read</div>
    @else
        <div class="badge badge-light-danger">Unread</div>
    @endif
</x-livewire-tables::bs5.table.cell>
...
<x-livewire-tables::bs5.table.cell>
    <div class="d-flex justify-content-center">
        ...
        <a title="{{__('messages.common.delete')}}" href="javascript:void(0)" data-id="{{ $row->id }}"
           class="btn enquiry-delete-btn btn-icon btn-bg-light text-hover-danger btn-sm ms-1" data-turbolinks="false">
