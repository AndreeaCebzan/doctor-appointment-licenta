<x-livewire-tables::bs5.table.cell>
    <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
        <div class="symbol-label">
            <img src="{{ $row->icon }}" class="w-100 object-cover">
        </div>
    </div>
...
<x-livewire-tables::bs5.table.cell>
    <div class="form-check form-switch form-check-custom form-check-solid me-10  justify-content-center">
...
<x-livewire-tables::bs5.table.cell>
    <div class="d-flex justify-content-center">
        ...
        <a href="javascript:void(0)" data-id="{{ $row->id }}"
           class="service-delete-btn btn btn-icon btn-bg-light text-hover-danger btn-sm ms-1" data-bs-toggle="tooltip"
