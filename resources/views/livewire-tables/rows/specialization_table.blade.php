...
<x-livewire-tables::bs5.table.cell>
    <div class="d-flex justify-content-center">
        <a href="javascript:void(0)" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 specialization-edit-btn"
        ...
        <a href="javascript:void(0)" data-id="{{$row->id}}"
           class="specialization-delete-btn btn btn-icon btn-bg-light text-hover-danger btn-sm ms-1"
