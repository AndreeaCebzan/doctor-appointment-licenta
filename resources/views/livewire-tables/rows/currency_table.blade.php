...
<x-livewire-tables::bs5.table.cell class="text-center">
    <div class="d-flex justify-content-center">
        <a href="javascript:void(0)" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 currency-edit-btn"
           data-id="{{$row->id}}" data-bs-toggle="tooltip" title="{{ __('messages.common.edit') }}">
        ...
        <a href="javascript:void(0)" data-id="{{$row->id}}"
           class="currency-delete-btn btn btn-icon btn-bg-light text-hover-danger btn-sm ms-1" data-bs-toggle="tooltip"
