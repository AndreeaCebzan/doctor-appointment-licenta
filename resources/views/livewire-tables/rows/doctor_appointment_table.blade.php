...
<x-livewire-tables::bs5.table.cell>
    @php
        $patientUrl = getLogInUser()->hasRole('doctor') ? route('doctors.patient.detail', $row->patient->id) : route(
...
<x-livewire-tables::bs5.table.cell>
    <div class="w-150px d-flex align-items-center">
        ...
        <select
            class="form-select-sm form-select-solid form-select doctor-show-apptment-status doctor-show-apptment-status"
...
<x-livewire-tables::bs5.table.cell>
    <div class="d-flex justify-content-center">
        ...
        <a title="{{__('messages.common.delete')}}" href="javascript:void(0)" data-id="{{ $row->id }}"
           class="btn doctor-show-apptment-delete-btn btn-icon btn-bg-light text-hover-danger btn-sm ms-2"
