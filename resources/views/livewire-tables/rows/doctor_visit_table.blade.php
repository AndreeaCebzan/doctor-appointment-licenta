<x-livewire-tables::bs5.table.cell>
    ...
    <div class="d-inline-block align-top">
        <div class="d-inline-block align-self-center d-flex">
            <a class="text-primary-800 mb-1 d-block">{{ $row->visitPatient->user->full_name }}
            </a>
        </div>
...
<x-livewire-tables::bs5.table.cell>
    <div class="d-flex justify-content-center">
        <a href="{{ route('doctors.visits.edit', $row->id) }}"
           class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm edit-btn me-1" data-bs-toggle="tooltip"
        ...
        <a href="{{ route('doctors.visits.show', $row->id) }}" title="{{ __('messages.common.show') }}"
           class="btn btn-icon btn-bg-light text-hover-primary btn-sm me-1 ms-1" data-bs-toggle="tooltip">
            <i class="fas fa-eye fs-4"></i>
        </a>
        <a href="#" data-id="{{ $row->id }}"
           class="doctor-visit-delete-btn btn btn-icon btn-bg-light text-hover-danger btn-sm ms-1"
