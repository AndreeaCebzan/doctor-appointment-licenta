...
<x-livewire-tables::bs5.table.cell>
    <div class="badge badge-light-danger mx-auto d-block" style="width: fit-content;">
        {{ $row->services_count }}
    </div>
</x-livewire-tables::bs5.table.cell>
...
<x-livewire-tables::bs5.table.cell>
    <div class="d-flex justify-content-center">
        <a title="{{__('messages.common.edit')}}" href="javascript:void(0)"
           class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 service-category-edit-btn"
           data-id="{{$row->id}}"
        ...
        <a title="{{__('messages.common.delete')}}" href="javascript:void(0)" data-id="{{ $row->id }}"
           class="btn service-category-delete-btn btn-icon btn-bg-light text-hover-danger btn-sm ms-1"
           data-turbolinks="false">
                        <span class="svg-icon svg-icon-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24"
                             version="1.1">
