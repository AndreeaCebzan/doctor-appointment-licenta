...
<x-livewire-tables::bs5.table.cell>
    <span class="badge badge-light-primary fs-7 custom-center">{{ $row->session_meeting_time }}</span>
</x-livewire-tables::bs5.table.cell>

<x-livewire-tables::bs5.table.cell>
    <div class="d-flex justify-content-center">
        <a title="{{__('messages.common.edit')}}" href="{{ route('doctor-sessions.edit', $row->id) }}"
        ...
        <a title="{{__('messages.common.delete')}}" href="javascript:void(0)" data-id="{{ $row->id }}"
           class="btn doctor-session-delete-btn btn-icon btn-bg-light text-hover-danger btn-sm ms-1"
           data-turbolinks="false">
                        <span class="svg-icon svg-icon-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24"
                             version="1.1">
