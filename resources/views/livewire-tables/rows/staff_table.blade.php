<x-livewire-tables::bs5.table.cell>
    ...
    <div class="d-inline-block align-top">
        <a href="{{route('staff.show', $row->id)}}"
           class="text-primary-800 mb-1 d-block">{{ $row->first_name.' '.$row->last_name}}</a>
...
<x-livewire-tables::bs5.table.cell>
    <div class="d-flex justify-content-center">
        <a title="{{__('messages.common.edit')}}" href="{{ route('staff.edit', $row->id) }}"
        ...
        <a title="{{__('messages.common.delete')}}" href="javascript:void(0)" data-id="{{ $row->id }}"
           class="btn staff-delete-btn btn-icon btn-bg-light text-hover-danger btn-sm ms-1" data-turbolinks="false">
            <span class="svg-icon svg-icon-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24"
                     version="1.1">
