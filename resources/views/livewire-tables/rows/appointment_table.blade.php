...
<x-livewire-tables::bs5.table.cell>
    <select class="form-select-sm form-select-solid form-select appointment-change-payment-status payment-status w-auto"
...
<x-livewire-tables::bs5.table.cell>
    <div class="w-150px d-flex align-items-center">
        ...
        <select class="form-select-sm form-select-solid form-select appointment-status-change appointment-status"
                data-control="select2"
                data-id="{{$row->id}}">
...
<x-livewire-tables::bs5.table.cell>
    <div class="d-flex justify-content-center">
        ...
        <a title="{{__('messages.common.delete')}}" href="javascript:void(0)" data-id="{{ $row->id }}"
           class="btn appointment-delete-btn btn-icon btn-bg-light text-hover-danger btn-sm ms-2"
