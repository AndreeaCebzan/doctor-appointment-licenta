                ...
                @if(getLogInUser()->hasRole('doctor') || getLogInUser()->hasRole('patient'))
                    <!--begin::Notifications-->
                        ...
                        <div class="d-flex align-items-center ms-1 me-lg-3 notification-dropdown">
                            <!--begin::Menu wrapper-->
                            <div
                                class="btn btn-icon btn-active-light-primary w-30px h-30px w-md-40px h-md-40px notification-icon position-relative"
                                title="Notifications" data-kt-menu-trigger="click" data-kt-menu-attach="parent"
                                data-kt-menu-placement="bottom-end">
                                <i class="far fa-bell"></i>
                                @if(count($notifications) != 0)
                                    <span
                                        class="badge navbar-badge bg-primary notification-count notification-message-counter rounded-circle position-absolute translate-middle d-flex justify-content-center align-items-center"
                                        id="counter">{{ count($notifications) }}</span>
                                @endif
                            </div>
                            <!--begin::Menu-->
                            <div class="menu menu-sub menu-sub-dropdown menu-column w-250px  h-375px w-lg-350px"
                                 data-kt-menu="true" style="">
                                <div class="dropdown-header rounded-top">
                                    <div class="row justify-content-between">
                                        <h3 class="px-3 col-5 notification-header">Notifications</h3>
                                        <div
                                            class="px-3 col-7 text-end {{ count($notifications) > 0 ? '' : 'd-none' }} align-self-center"
                    ...
                    <!--begin::Menu wrapper-->
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px"
                            ...
                            @if(session('impersonated_by'))
                                <div class="menu-item px-5">
                                    <a class="menu-link px-5" data-turbo="false"
