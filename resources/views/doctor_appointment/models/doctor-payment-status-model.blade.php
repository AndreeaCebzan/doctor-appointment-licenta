<div class="modal show fade" id="doctorAppointmentPaymentStatusModal" aria-modal="true" role="dialog">
                ...
                <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll"
                    ...
                    <div class="fv-row fv-plugins-icon-container">
                        <div class="mb-5">
                            ...
                            'class' => 'form-select form-select-solid','data-dropdown-parent'=>'#doctorAppointmentPaymentStatusModal',
