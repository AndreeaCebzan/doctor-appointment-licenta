...
@section('content')
    <div class="post d-flex flex-column-fluid" id="kt_post">
        <div id="kt_content_container" class="container">
            ...
            ['id' => 'settingStateId','class' => 'form-select form-select-solid form-select-lg fw-bold','data-control'=>'select2','required', 'placeholder' => 'Select State']) }}
                            </div>
                        </div>
                        <div class="row mb-6">
                            <label class="col-lg-4 col-form-label fw-bold fs-6">
               ...
               $setting['city_id'] ?? null,['id' => 'settingCityId','class' => 'form-select form-select-solid form-select-lg fw-bold','data-control'=>'select2','required']) }}
                            </div>
                        </div>
                        <div class="row mb-6">
