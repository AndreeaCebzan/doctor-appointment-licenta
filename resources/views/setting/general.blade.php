...
@section('content')
                    ...
                    <div class="card-body border-top p-9 pb-0">
                        ...
                        <div class="row mb-6 align-items-center">
                            ...
                            <div class="col-lg-8 fv-row ms-auto">
                                {{ Form::tel('contact_no','+'.$setting['region_code'].$setting['contact_no'] ?? null,['class' => 'form-control form-control-solid','placeholder' => 'Contact number','onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")','id'=>'phoneNumber', 'required']) }}
    ...
    {{--    <script>--}}
    {{--        phoneNo = "{{ ($setting['region_code']).($setting['contact_no']) }}"--}}
    {{--    </script>--}}
@endsection
