<div class="row mb-5">
    ...
    <div class="col-md-6 mb-5">
        ...
        {{ Form::text('dob', $user->dob,['class' => 'form-control form-control-solid doctor-dob','placeholder' => 'DOB', 'id'=>'dob']) }}
    </div>
    <div class="col-md-6 mb-5">
...
['class' => 'form-control form-control-solid form-select', 'data-control'=>"select2", 'id'=>'editDoctorCountryId','placeholder' => 'Select Country']) }}
    </div>
    <div class="d-flex col-md-6 flex-column mb-7 fv-row">
        {{ Form::label('State',__('messages.doctor.state').':' ,['class' => 'form-label fs-6 fw-bolder text-gray-700 mb-3']) }}
        {{ Form::select('state_id', (isset($state) && $state!=null) ? $state:[], isset($user->address->state_id) ? $user->address->state_id:null, ['class' => 'form-control form-control-solid form-select', 'data-control'=>"select2", 'id'=> 'editDoctorStateId','placeholder' => 'Select State']) }}
    </div>
    <div class="d-flex col-md-6 flex-column mb-7 fv-row">
        {{ Form::label('City',__('messages.doctor.city').':' ,['class' => 'form-label fs-6 fw-bolder text-gray-700 mb-3']) }}
        {{ Form::select('city_id', (isset($cities) && $cities!=null) ? $cities:[], isset($user->address->city_id) ? $user->address->city_id:null, ['class' => 'form-control form-control-solid form-select', 'data-control'=>"select2", 'id'=> 'editDoctorCityId','placeholder' => 'Select City']) }}
    </div>
...
<div class="d-flex flex-stack align-items-sm-center align-items-start flex-sm-row flex-column">
    ...
    <a class="btn btn-primary float-end mt-sm-0 mt-2" id="addQualification">{{__('messages.doctor.add_qualification')}}</a>
</div>
...
<div class="row showQualification w-100">
    <div class="d-flex col-md-4 flex-column mb-7 fv-row">
        ...
        {{ Form::text('degree', null, ['class' => 'form-control form-control-solid degree', 'placeholder' => 'Degree', 'id'=>'degree']) }}
    </div>
    <div class="d-flex col-md-4 flex-column mb-7 fv-row">
        {{ Form::label('university', __('messages.doctor.university').':', ['class' => 'form-label required fs-6 fw-bolder text-gray-700 mb-3']) }}
        {{ Form::text('university', null, ['class' => 'form-control form-control-solid university', 'placeholder' => 'University', 'id'=>'university']) }}
    </div>
    <div class="d-flex col-md-4 flex-column mb-7 fv-row">
        <label class="fs-6 fw-bold mb-2 required">{{__('messages.doctor.year')}}:</label>
        {{ Form::select('year', $years,!empty($qualifications->year) ? $qualifications->year : null, ['class' => 'form-control form-control-solid form-select year', 'data-control'=>"select2", 'id'=> 'year', 'placeholder' => 'Select Year']) }}
    </div>
