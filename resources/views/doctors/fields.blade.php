<div class="row gx-10 mb-5">
    ...
    <div class="col-md-6 mb-5">
        ...
        {{ Form::text('dob', null,['class' => 'form-control form-control-solid doctor-dob','placeholder' => 'DOB', 'id'=>'dob']) }}
    </div>
    <div class="col-md-6 mb-5">
...
<div class="row gx-10 mb-5">
    ...
    <div class="d-flex col-md-6 flex-column mb-7 fv-row">
        ...
        {{ Form::select('country_id', $country, null,['class' => 'form-control form-control-solid form-select', 'data-control'=>"select2", 'id'=>'editDoctorCountryId','placeholder' => 'Select Country']) }}
    </div>
    <div class="d-flex col-md-6 flex-column mb-7 fv-row">
        {{ Form::label('State',__('messages.doctor.state').':' ,['class' => 'form-label fs-6 fw-bolder text-gray-700 mb-3']) }}
        {{ Form::select('state_id', [], null,['class' => 'form-control form-control-solid form-select', 'data-control'=>"select2", 'id'=> 'editDoctorStateId','placeholder' => 'Select State']) }}
    </div>
    <div class="d-flex col-md-6 flex-column mb-7 fv-row">
        {{ Form::label('City',__('messages.doctor.city').':' ,['class' => 'form-label fs-6 fw-bolder text-gray-700 mb-3']) }}
        {{ Form::select('city_id', [], null,['class' => 'form-control form-control-solid form-select', 'data-control'=>'select2', 'id'=> 'editDoctorCityId','placeholder' => 'Select City']) }}
    </div>
