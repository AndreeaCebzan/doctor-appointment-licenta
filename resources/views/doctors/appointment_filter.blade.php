...
<div class="me-4 align-items-center" wire:ignore>
    ...
    <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
        ...
        <div class="px-7 py-5">
            ...
            <div class="mb-10">
                ...
                <div>
                    {{ Form::select('status', $appointmentStatus, \App\Models\Appointment::BOOKED,['class' => 'form-control form-control-solid form-select', 'data-control'=>"select2", 'id' => 'doctorShowAppointmentStatus']) }}
                </div>
            </div>
            <div class="d-flex justify-content-end">
                <button type="reset"
                        ...
                        id="doctorShowApptmentResetFilter">{{__('messages.common.reset')}}</button>
