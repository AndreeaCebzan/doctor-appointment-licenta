<div class="d-flex align-sm-items-center align-items-start flex-sm-row flex-column ms-auto">
            ...
            <div class="mb-10">
                ...
                <div>
                    <input class="form-control form-control-solid"
                           ...
                           id="patientShowPageAppointmentDate"/>
                </div>
            </div>
            <div class="mb-10">
                <label class="form-label fw-bold">{{__('messages.doctor.status')}}</label>
                <div>
                    {{ Form::select('status', $appointmentStatus, \App\Models\Appointment::BOOKED,['class' => 'form-control form-control-solid form-select', 'data-control'=>"select2", 'id' => 'patientShowPageAppointmentStatus']) }}
                </div>
            </div>
            <div class="d-flex justify-content-end">
                <button type="reset" id="patientAppointmentResetFilter"
