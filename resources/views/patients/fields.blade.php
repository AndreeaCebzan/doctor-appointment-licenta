<div class="row gx-10 mb-5">
    ...
    <div class="col-md-6 mb-5">
        ...
        {{ Form::text('dob',!empty($patient->user) ? $patient->user->dob : null,['class' => 'form-control form-control-solid patient-dob','id' => 'dob', 'placeholder' => 'DOB']) }}
    </div>
    <div class="col-md-6 mb-5">
...
<div class="row">
    ...
    <div class="d-flex col-md-6 flex-column mb-7 fv-row">
        ...
        {{ Form::select('country_id', $data['countries'] ,null, ['id' => 'patientCountryId','data-placeholder' => 'Select Country','class' => 'form-select form-select-solid form-select-lg fw-bold', 'aria-label'=>"Select a Country",
        'data-control'=>'select2']) }}
    </div>
    <div class="d-flex col-md-6 flex-column mb-7 fv-row">
        {{ Form::label('state_id',__('messages.state.state').':',['class'=>'form-label fs-6 fw-bolder text-gray-700 mb-2']) }}
        {{ Form::select('state_id', [], null, ['id' => 'patientStateId','class' => 'form-select form-select-solid form-select-lg fw-bold',
'data-placeholder' => 'Select State','aria-label'=>"Select State",'data-control'=>'select2']) }}
    ...
    <div class="d-flex col-md-6 flex-column mb-7 fv-row">
        ...
        {{ Form::select('city_id', [], null, ['id' => 'patientCityId','class' => 'form-select form-select-solid form-select-lg fw-bold', 'data-placeholder' => 'Select City','aria-label'=>"Select City",'data-control'=>'select2']) }}
    </div>
