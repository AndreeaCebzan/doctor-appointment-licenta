            ...
            <div class="card mb-5 mb-xl-10">
                <div class="card-body  border-top p-9">
                    ...
                    <div class="row mb-7">
                        ...
                        <div class="col-lg-8 fv-row">
                            <span class="fw-bolder fs-6 text-gray-800">{{ !empty($transaction['data']->type) ? \App\Models\Appointment::PAYMENT_METHOD[$transaction['data']->type] : __('messages.common.n/a') }}</span>
                        </div>
                    </div>
                    <div class="row mb-7">
