            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 mb-6">
                ...
                <div class="row gx-10">
                    <div class="fv-row mb-7 fv-plugins-icon-container">
                        {{ Form::label('name', __('messages.common.name').':', ['class' => 'required form-label fs-6 fw-bolder text-gray-700 mb-3']) }}
                        {{ Form::text('name', null, ['class' => 'form-control form-control-solid mb-3 mb-lg-0', 'placeholder' => 'Name',                                        'required','id'=>'editServiceCategoryName']) }}
