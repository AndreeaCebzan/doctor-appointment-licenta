                                ...
                                <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
                                    ...
                                    <div class="px-7 py-5">
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <!--begin::Input-->
                                            <div>
                                                {{ Form::select('service',$data['serviceCategoriesArr'],null,['class' => 'form-select form-select-solid','placeholder' => 'Select Category', 'id' => 'serviceCategoryId', 'data-control' => 'select2']) }}
                                            </div>
                                            <!--end::Input-->
                                        </div>
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <!--begin::Input-->
                                            <div>
                                                {{ Form::select('doctor_id',$data['doctorArr'],null,['class' => 'form-select form-select-solid','placeholder' => 'Select Doctor', 'id' => 'dashboardDoctorId', 'data-control' => 'select2']) }}
                                            </div>
                                            <!--end::Input-->
                                        </div>
                                        <!--begin::Actions-->
                                        <div class="d-flex justify-content-end">
                                            <button type="reset"
                                                    ...
                                                    data-kt-menu-dismiss="true" id="dashboardResetBtn">Reset
                                            </button>
