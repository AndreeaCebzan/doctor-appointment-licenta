            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 mb-6">
                ...
                <div class="row gx-10">
                    <div class="fv-row mb-7 fv-plugins-icon-container">
                        ...
                        {{ Form::text('name', null, ['class' => 'form-control form-control-solid mb-3 mb-lg-0', 'placeholder' => 'Name',                                         'required','id'=>'editCityName']) }}
                        <div class="fv-plugins-message-container invalid-feedback"></div>
                    </div>
                    <div class="fv-row mb-7 fv-plugins-icon-container">
                        {{ Form::label('state_id', __('messages.city.state').':', ['class' => 'required fw-bold fs-6 mb-2']) }}
                        {{ Form::select('state_id', $states, null, ['id' => 'editCityStateId','data-dropdown-parent'=>'#editCityModal',
