<div class="row gx-10 mb-5">
    <div class="col-lg-6">
        <div class="mb-5">
            ...
            {{ Form::text('visit_date', isset($visit) ? $visit['visit_date'] : null, ['class' => 'form-control form-control-solid visit-date', 'id' => isset($visit) ? 'editDate' : 'date','placeholder' => 'Visit Date']) }}
        </div>
    </div>
    @role('doctor')
