<div class="modal show fade" id="paymentStatusModal" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 mb-6">
                {{ Form::open(['id' => 'appointmentPaymentStatusForm'])}}
                {{ Form::hidden('payment_status',null,['id'=>'paymentStatus']) }}
                ...
                <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll"
                    ...
                    <div class="fv-row fv-plugins-icon-container">
                        <div class="mb-5">
                            {{ Form::select('payment_status', $paymentStatus, null, ['id' => 'paymentType',
                            'class' => 'form-select form-select-solid','data-dropdown-parent'=>'#paymentStatusModal',
