<div class="row gx-10 mb-5">
    <div class="d-flex col-sm-12 col-lg-6 flex-column mb-7 fv-row">
        ...
        {{ Form::select('doctor_id', $data['doctors'], null,['class' => 'form-control form-control-solid form-select', 'id' => 'adminAppointmentDoctorId', 'data-control'=>"select2", 'required','placeholder' => 'Select Doctor']) }}
    </div>
    <div class="col-lg-6 mb-5 col-sm-12">
        ...
        {{ Form::text('date', null,['class' => 'form-control form-control-solid date','placeholder' => 'Select Date', 'id'=>'appointmentDate', 'required','autocomplete'=>'off','disabled' => true]) }}
    </div>
    @role('patient')
    ...
    @else
        <div class="d-flex col-lg-6 col-sm-12 flex-column mb-7 fv-row">
            ...
            {{ Form::select('service_id', [], null,['class' => 'form-control form-control-solid form-select', 'data-control'=>"select2", 'id'=> 'appointmentServiceId','placeholder' => 'Select Service','required']) }}
        </div>
            {{ Form::hidden('status',\App\Models\Appointment::BOOKED) }}
        <div class="d-flex col-sm-12 col-lg-6 flex-column mb-7 fv-row">
