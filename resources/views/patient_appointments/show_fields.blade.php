                ...
                <div>
                    <div class="card-body  border-top p-9">
                        ...
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-8 fv-row">
                                <span class="fw-bolder fs-6 bold">{{ getCurrencyIcon() }} {{$appointment['data']->payable_amount}}</span>
                            </div>
                        </div>
                        <div class="row mb-7">
                        ...
                        @if($appointment['data']->payment_type === \App\Models\Appointment::PAID)
                            <div class="row mb-7">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <span class="fw-bolder fs-6 text-gray-800">{{ isset($appointment['data']->payment_method) ? \App\Models\Appointment::PAYMENT_METHOD[$appointment['data']->payment_method] : __('messages.common.n/a')}}</span>
                                </div>
                            </div>
                        @endif
                        <div class="row mb-7">
