            ...
            <div class="card mb-5 mb-xl-10">
                <div>
                    <div class="card-body  border-top p-9">
                        ...
                        <div class="row mb-7">
                            <label
                                class="col-lg-4 fw-bold text-muted">{{ __('messages.patient.registered_on') }}</label>
                            <div class="col-lg-8">
                                <span class="fw-bold fs-6 text-gray-800 me-2 " data-bs-toggle="tooltip"
                                      data-bs-placement="right"
                                      title="{{\Carbon\Carbon::parse($enquiry->created_at)->format('jS M Y')}}">
                        ...
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-8">
                                <span class="fw-bold fs-6 text-gray-800 me-2" data-bs-toggle="tooltip"
                                      data-bs-placement="right"
                                      title="{{\Carbon\Carbon::parse($enquiry->updated_at)->format('jS M Y')}}">
