<div class="row gx-10 mb-5">
    <div class="col-lg-6">
        <div class="mb-5">
            ...
            {{ Form::text('title', null, ['class' => 'form-control form-control-solid', 'placeholder' => 'Title', 'required']) }}
        </div>
    </div>
    <div class="col-lg-6">
        <div class="mb-5">
            ...
            {{ Form::textarea('short_description', null, ['class' => 'form-control form-control-solid', 'placeholder' => 'Short Description', 'required', 'rows'=> 5,'id'=>'sliderShortDescription']) }}
        </div>
    </div>
    <div class="col-lg-6 mb-7">
        <div class="justify-content-center">
            <label class="form-label fs-6 fw-bolder required text-gray-700 mr-3">{{ __('messages.slider.image').':' }}</label><span
